...
# This script is close to unreadable. It works, but it's not pretty.
# After forking, I updated to work with yq v4, and added a few other small changes to work better with private repos.
